...
SQLRETURN SQL_API SQLColAttributesW(
    ...
    SQLSMALLINT    *pcbDesc,
    SQLLEN         *pfDesc); /* DC_20110223_4145 */
...
SQLRETURN SQL_API SQLDescribeColW(
    ...
    SQLULEN        *pcbColDef, /* DC_20110223_4145 */
...
SQLRETURN SQL_API SQLGetDescRecW(
    ...
    SQLLEN         *pLength,    /* DC_20110223_414 */
...
SQLRETURN SQL_API SQLSetConnectOptionW(
    SQLHDBC            hdbc,
    SQLUSMALLINT       fOption,
    SQLULEN            vParam); /* DC_20110223_4145 */
...
SQLRETURN SQL_API SQLColAttributeA(
	...
	SQLSMALLINT		cbCharAttrMax,
	SQLSMALLINT  *pcbCharAttr,
#if defined(FAIRCOM_MOD) && defined(DH_64BIT_MODEL)
	SQLLEN			*pNumAttr);
#else
	SQLPOINTER		pNumAttr);
#endif
...
#ifndef	SQL_NOUNICODEMAP	/* define this to disable the mapping */ /* FAIRCOM_MOD */
#ifdef 	UNICODE

#define	SQLColAttribute		SQLColAttributeW
#ifndef SQLColAttributes /* FAIRCOM_MOD */
