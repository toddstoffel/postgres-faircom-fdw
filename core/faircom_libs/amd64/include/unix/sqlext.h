...
/*DC371 BEGIN DC_19990326_676*/
/*Since Dharma SQL engine does supports non-deferrable constraints, we have */
/*to return SQL_NOT_DEFERRABLE for DEFERRABILITY column of SQLFOreignKeys*/
#define SQL_NOT_DEFERRABLE                      7

/* DC371 END DC_19990326_676  */
...
/* this function is now internal and does not
* behave exactly like the deprecated ODBC 2.0 function
*/
#define SQLColAttributes iSQLColAttributes
#endif
...
SQLRETURN SQL_API SQLDescribeParam(
    ...
    SQLULEN     	  *pcbParamDef,  /* DC_20110223_4145*/
...
SQLRETURN SQL_API SQLExtendedFetch(
    ...
    SQLLEN             irow,        /* DC_20110223_4145*/
    SQLULEN 	       *pcrow,      /* DC_20110223_4145*/
...
SQLRETURN SQL_API SQLParamOptions(
    SQLHSTMT           hstmt,
    SQLULEN            crow,         /* DC_20110223_4145*/
    SQLULEN     	  *pirow);   /* DC_20110223_4145*/
...
SQLRETURN SQL_API SQLSetPos(
    SQLHSTMT           hstmt,
    SQLSETPOSIROW       irow,  /* DC_20110223_4145*/
...
SQLRETURN SQL_API SQLBindParameter(
    ...
    SQLULEN        cbColDef,         /* DC_20110223_4145*/
    SQLSMALLINT        ibScale,
    SQLPOINTER         rgbValue,
    SQLLEN         cbValueMax,      /* DC_20110223_4145*/
    SQLLEN 	     *pcbValue);   /* DC_20110223_4145*/
...
SQLRETURN SQL_API SQLSetScrollOptions(    /*      Use SQLSetStmtOptions */
    ...
    SQLLEN             crowKeyset,    /* DC_20110223_4145*/
...
/* BEGIN DC415 */
/* The defintion of datatypes like SQL_C_TCHAR is present in the file
   "sqlucode.h". It has to be included for UNIX also
*/
/* #if defined(WIN32) */
#include "sqlucode.h"
/*#endif */
...
#if defined (DH_OS_WINNT) || defined (DH_OS_WIN95) /* dharma 3.0 driver */
