/*
 * $Id: linkhash.h 280104 2022-01-27 18:40:24Z enrico $
 *
 ...
 */
/* #if !defined(_MSC_VER) || (_MSC_VER > 1800) */ 	/* VS2010 can't handle inline funcs, so skip it there */
#if (defined(_MSC_VER) && (_MSC_VER > 1800)) 		/* Ray A deactivated _LH_INLINE for UNIX ports */
 ...
 */
static _LH_INLINE unsigned long lh_get_hash(const struct lh_table *t, const void *key)
{
	return t->hash_fn(key);
}
