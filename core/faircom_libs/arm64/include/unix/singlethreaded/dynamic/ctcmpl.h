...
/* from cttest in 32bit mode:
8 Byte Mem Align Test for CTOPTN.H:
        Use the following setup in CTOPTN.H -   #define ctMEMALIGN8
*/
#define ctMEMALIGN8
...
#define NO_ctFeatAUTO_SHMEM /* We have not verified the Shared Memory for this platform */
#endif
#define ctNO_WCHAR
#else
#define ctUNICODEswap
#endif
