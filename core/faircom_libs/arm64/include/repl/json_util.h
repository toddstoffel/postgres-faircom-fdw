/*
 * $Id: json_util.h 164189 2018-04-06 20:16:44Z jeff $
 *
...
#endif
#else
#define JSON_UTIL_EXPORT extern
#endif
 ...
 */
JSON_UTIL_EXPORT struct json_object* json_object_from_file(const char *filename);
 ...
 * Returns -1 if something fails.  See json_util_get_last_err() for details.
 */
JSON_UTIL_EXPORT struct json_object* json_object_from_fd(int fd);
 ...
 * Returns -1 if something fails.  See json_util_get_last_err() for details.
 */
JSON_UTIL_EXPORT int json_object_to_file(const char *filename, struct json_object *obj);
 ...
 * Returns -1 if something fails.  See json_util_get_last_err() for details.
 */
JSON_UTIL_EXPORT int json_object_to_file_ext(const char *filename, struct json_object *obj, int flags);
 ...
 */
JSON_UTIL_EXPORT int json_object_to_fd(int fd, struct json_object *obj, int flags);
 ...
 */
JSON_UTIL_EXPORT const char *json_util_get_last_err(void);


JSON_UTIL_EXPORT int json_parse_int64(const char *buf, int64_t *retval);
JSON_UTIL_EXPORT int json_parse_double(const char *buf, double *retval);

/**
 * Return a string describing the type of the object.
 * e.g. "int", or "object", etc...
 */
JSON_UTIL_EXPORT const char *json_type_to_name(enum json_type o_type);
